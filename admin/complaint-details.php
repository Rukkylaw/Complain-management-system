	...
	<div class="module">
			...
			{	?>									
									...
									<td> <?php echo htmlentities($row['Faculty']);?></td>
										...
										<tr>
											<td><b>Message</b></td>	
											<td colspan="4"  style="height:auto;text-align:justify;font-weight: bold"> <?php echo htmlentities($row['message']);?></td>
										</tr>
										...
										<tr>
											...
											?>
										<a href="../user/attach/<?php echo htmlentities($row['attach']);?>" target="_blank"/> Click to view or download file</a>
										<?php } ?></td>
										</tr>
										...
										<tr>
											<td><b>Action</b></td>										
											<td colspan="4"><a  class="btn btn-primary" style="font-family: ariel;" href="update_status.php?ref_num=<?php echo $cid; ?>" >Click-to-process</a>
											</td></td>
										</tr>
									<?php } else{ } ?>
					...
					<?php
					$id= $_GET['cid'];
						$qry = "SELECT * FROM tblcomplaints WHERE ref_num = '$id'";
 				 ...
 				 <div class="col-lg-6" style="margin-top: 10px;">
                    <div class="panel panel-default"> 
                     ...
                     <center><h4>Administrator: Reply Message</h4></center>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                      <tr>
                                            ...
                                            <td><input type="text" value="<?php echo $row['Matricnumber']; ?>" name="Fname" disabled="" class="form-control"></td> 
                                        </tr>
                                        <tr>
                                            <td style="float: right;"><b>Message:</b></td>
                                            <td><textarea name="message" required="" class="form-control" rows="6"></textarea></td>
                                        </tr>
                                        <tr>
                                            <td style="float: right;"><b>Attach Document (Optional):</b></td>
                                            <td><input type="file" name="attach" class="form-control"></td> 
                                        </tr>
                                       
                                         <tr>
                                            <td  style="float: right;">&nbsp;</td>
                                            <td><button class="btn btn-success" name="replymessage">Send Message</button></td>
                                        </tr>
                                    </tbody>
                                </table>
                                </form>
