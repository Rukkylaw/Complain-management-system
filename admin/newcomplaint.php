...
<head>
	...
	<title>Admin| New Complaints</title>
...
<tbody>
<?php 
$query=mysql_query("SELECT * FROM tblcomplaints WHERE status ='0' ");
...
?>										
										<tr>
											...
											<td><button type="button" class="btn btn-danger">Not-process</button></td>
											
											<td>   <a href="complaint-details.php?cid=<?php echo htmlentities($row['ref_num']);?>"> View Details</a> 
											</td>
											</tr>
